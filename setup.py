...
requires = [
    ...
    "flockwave-ext @ https://git.collmot.com/collmot/flockwave-ext/archive/1.1.1.tar.gz",
    ...
    "flockwave-spec @ https://git.collmot.com/collmot/flockwave-spec/archive/0.24.0.tar.gz",
    "jsonschema>=3.0.1",
    "netifaces>=0.10.5",
    "pynmea2>=1.12.0",
