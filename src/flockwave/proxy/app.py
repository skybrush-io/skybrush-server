...
class SkybrushProxyServer(DaemonApp):
    ...
    async def supervise_local_connection(self, conn: RWConnection) -> None:
    ...
    async def supervise_remote_connection(self, conn: RWConnection) -> None:
        assert self.connection_supervisor is not None
        await self.connection_supervisor.supervise(
