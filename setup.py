...
requires = [
    ...
    "flockwave-gps @ https://git.collmot.com/collmot/flockwave-gps/archive/0.12.0.tar.gz",
    ...
    "flockwave-spec @ https://git.collmot.com/collmot/flockwave-spec/archive/0.23.0.tar.gz",
    "jsonschema>=3.0.1",
    "netifaces>=0.10.5",
    "pynmea2>=1.12.0",
