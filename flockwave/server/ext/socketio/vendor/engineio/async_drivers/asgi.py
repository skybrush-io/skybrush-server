...
class ASGIApp:
    ...
    also forward unrelated HTTP traffic to another ASGI application.
    ...
    def __init__(self, engineio_server, other_asgi_app=None, engineio_path="engine.io"):
