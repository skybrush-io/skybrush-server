...
class Server(object):
            ...
            if sid is None:
                ...
                if transport != "polling" and transport != "websocket":
                    ...
                    r = self._handle_connect(
                        environ, start_response, transport, b64, jsonp_index
                    )
            else:
    ...
    def _handle_connect(
        self, environ, start_response, transport, b64=False, jsonp_index=None
    ):
        ...
        if transport == "websocket":
            ...
            try:
                return self._ok(
                    s.poll(), headers=headers, b64=b64, jsonp_index=jsonp_index
                )
    ...
    def _upgrades(self, sid, transport):
        ...
        if (
            ...
            or self._async["websocket"] is None
    ...
    def _cors_allowed_origins(self, environ):
        ...
        if self.cors_allowed_origins is None:
            allowed_origins = [default_origin] if default_origin is not None else []
